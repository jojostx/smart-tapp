...
class RangeSlider extends Field
{
    ...
    protected function setUp(): void
    {
        ...
        $this->afterStateHydrated(static function (RangeSlider $component, $state): void {
            if (blank($component->getMin()) && blank($component->getSteps())) {
                $component->min(0);
            }

            if (blank($state)) {
                $component->state($component->getMin());
