...
class Subdomain implements Rule
{
    ...
    protected static $reserved = [
        ...
        'confirmation', 'contact', 'contact-u', 'contact-us', 'contactus', 'contactu', 'content', 'controlpanel', 'coon', 'core', 'corp', 'countrie',
        'country', 'cp', 'cpanel', 'crap', 'cs', 'css', 'css1', 'css2', 'css3', 'cunt', 'cum',
