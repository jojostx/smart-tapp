...
<div>
    ...
    <div x-data="{ show: true }" x-show="show" wire:poll.8s="redirectIfSubdomainIsCreated" class="fixed inset-0 z-10 flex flex-col items-center justify-center bg-gray-50">
