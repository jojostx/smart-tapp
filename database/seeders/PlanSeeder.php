...
class PlanSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    $vehicles_per_parking_lot = Feature::create([
      'name'       => 'vehicles-per-parking-lot',
      'description' => [
        'tag' => "Up to %d vehicles per parking lot",
    ...
    $standard->features()->attach($vehicles_per_parking_lot, ['units' => 50]);
    ...
    $premium->features()->attach($vehicles_per_parking_lot, ['units' => 100]);
    ...
    $enterprise->features()->attach($vehicles_per_parking_lot, ['units' => 200]);
